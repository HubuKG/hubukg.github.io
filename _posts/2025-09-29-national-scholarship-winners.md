...
**科研成果：**
- [1] Rethinking Tokenized Graph Transformers for Node Classification. NeurIPS 2025.(CCF A，共同第一作者)
- [2] Semantic Similarity Driven Multi-modal Model for Rumor Detection. ECAI 2024.(CCF B，第一作者)
...
**科研成果：**
- [1] ViT-EnsembleAttack: Augmenting Ensemble Models for Stronger Adversarial Transferability in Vision Transformers. ICCV 2025 (CCF A，第一作者)
- [2] Attention-Preserving Feature Distortion Method for Highly Transferable Adversarial Attack on Vision Transformers. ECAI 2025 (CCF B，共同第一作者)
...
**科研成果：**
- [1] ViT-EnsembleAttack: Augmenting Ensemble Models for Stronger Adversarial Transferability in Vision Transformers. ICCV 2025 (CCF A，共同第一作者)
- [2] Attention-Preserving Feature Distortion Method for Highly Transferable Adversarial Attack on Vision Transformers. ECAI 2025 (CCF B，第一作者)
- [3] Advancing SAR Image Robustness: Integrating Diffusion Models for Adversarial Purification and Speckle Noise Suppression. ICASSP2025 (CCF B，共同第一作者)
